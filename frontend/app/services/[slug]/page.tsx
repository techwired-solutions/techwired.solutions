            ...
            <div className="lg:w-1/3">
               <div className="sticky top-32 space-y-8">
                  ...
                  <div className="p-8 bg-blue-50 border border-blue-100 rounded-3xl">
                     ...
                     <a href="tel:+9779843641508" className="flex items-center justify-center gap-2 w-full py-4 bg-white text-[#0061ff] border border-[#0061ff]/20 rounded-xl font-bold hover:bg-[#0061ff] hover:text-white transition-all">
                        Call Us Now
                     </a>
                  </div>
               </div>
